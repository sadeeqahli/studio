...
export default function BookingPage() {
    ...
    const handleFlutterwavePayment = async () => {
        ...
        if (!currentUser || !pitch || !owner) {
            toast({ title: "Could not retrieve user, owner, or pitch data.", variant: "destructive" });
            return;
        }
        ...
        // =================================================================================
        // START: FLUTTERWAVE SPLIT PAYMENT IMPLEMENTATION GUIDE
        // =================================================================================
        //
        // To implement split payments, you need to provide a `subaccounts` array
        // in the payment configuration. Each object in this array represents a
        // destination for a portion of the payment.
        //
        // You would get the `subaccount_id` for the pitch owner from your database.
        // This ID is generated by Flutterwave when you create a subaccount for your owner.
        //
        // The commission is automatically calculated by Flutterwave based on your settings.
        // For this example, we're assuming you set up a 10% commission on your main
        ...
        const ownerSubaccountId = "RS_SUBACCOUNT_ID_FOR_TUNDE_OJO"; // EXAMPLE

        const splitPaymentConfig = [
            {
                id: ownerSubaccountId,
                // The transaction_charge_type determines who bears the Flutterwave fee.
                // 'flat_subaccount' means the subaccount (owner) pays a flat fee you define.
                // 'percentage_subaccount' means owner pays a percentage fee.
                // 'account' (default) means you (the main account) bear the fees.
                transaction_charge_type: "account", 
                transaction_charge: 0, // Not needed if you bear the fees.
            }
        ];
        
        // =================================================================================
        // END: FLUTTERWAVE SPLIT PAYMENT IMPLEMENTATION GUIDE
        // =================================================================================
        ...
        const paymentConfig = {
            ...
            subaccounts: splitPaymentConfig, // <-- THIS IS THE KEY FOR SPLIT PAYMENTS
            customer: {
