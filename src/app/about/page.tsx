        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-primary/5">
            <div className="container px-4 md:px-6">
                <div className="flex flex-col items-center space-y-4 text-center">
                    <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">About 9ja Pitch Connect</h1>
            ...
            <div className="container px-4 md:px-6 grid gap-12 lg:grid-cols-2 lg:gap-16">
                <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                        9ja Pitch Connect was founded by a group of friends who were tired of the hassle of finding and booking a good football pitch. We envisioned a single platform where anyone, anywhere in Nigeria, could find a great place to play the beautiful game. We believe that football has the power to unite communities, and our goal is to remove the barriers that stand between you and your next match.
                    </p>
                    <p className="text-muted-foreground">
                 ...
                 <Image
                    src="https://images.unsplash.com/photo-1527090442353-7b4c58c2341d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw1fHxhZnJpY2FuJTIwZm9vdGJhbGwlMjB0ZWFtfGVufDB8fHx8MTc1Mzc2MTI4OXww&ixlib=rb-4.1.0&q=80&w=1080"
                    width="600"
                    height="400"
